...
public class Gyeonbuk extends AppCompatActivity {
    ...
    TextView textView21_1, textView22_1, textView23_1;
    ...
    TextView textView21_2, textView22_2, textView23_2;
    ...
    TextView textView21_3, textView22_3, textView23_3;
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            textView6.setText(bundles6.getString("경북총확진자"));

            Bundle bundles7 = msg.getData();
            textView5.setText(bundles7.getString("경북신규확진자"));

            Bundle bundles8 = msg.getData();
            textView7.setText(bundles8.getString("경북완치"));

            Bundle bundles9 = msg.getData();
            textView8.setText(bundles9.getString("경북사망"));
