...
public class Quar extends AppCompatActivity {
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            textView6.setText(bundle6.getString("검역총확진자"));

            Bundle bundle7 = msg.getData();
            textView5.setText(bundle7.getString("검역신규확진자"));

            Bundle bundle8 = msg.getData();
            textView7.setText(bundle8.getString("검역완치"));
