...
public class Sejong extends AppCompatActivity {
        ...
        new Thread(){
            ...
            public void run(){
                ...
                try{
                    ...
                    Elements elements = doc.select("td.number");//태그로 가져오기
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            textView6.setText(bundle6.getString("세종총확진자"));

            Bundle bundle7 = msg.getData();
            textView5.setText(bundle7.getString("세종신규확진자"));

            Bundle bundle8 = msg.getData();
            textView7.setText(bundle8.getString("세종완치"));

            Bundle bundle9 = msg.getData();
            textView8.setText(bundle9.getString("세종사망"));
