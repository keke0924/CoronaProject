...
public class now extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //지역
        textView1_1 = findViewById(R.id.now_text);
        ...
        new Thread(){
            ...
            public void run(){
                ...
                try{
                    ...
                    Elements elements = doc.select(".mlp_message_list_area");//테그로 가져오기
...
//                    textView26_1.setText("기타");
                    ...
                    for(int i = 0; i<70;i++) {
                        String a = elements.select("li").get(i).text();
...
//                        }
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            textView1_1.setText(bundle2.getString("강남구총확진자"));
