...
public class Jeonnam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView1_1.setText("목포시");
        textView2_1.setText("여수시");
        textView3_1.setText("순천시");
        textView4_1.setText("나주시");
        textView5_1.setText("광양시");
        textView6_1.setText("담양군");
        textView7_1.setText("곡성군");
        textView8_1.setText("구래군");
        textView9_1.setText("고흥군");
        textView10_1.setText("보성군");
        textView11_1.setText("화순군");
        textView12_1.setText("장흥군");
        textView13_1.setText("강진군");
        textView14_1.setText("해남군");
        textView15_1.setText("영암군");
        textView16_1.setText("무안군");
        textView17_1.setText("함평군");
        textView18_1.setText("영광군");
        textView19_1.setText("장성군");
        textView20_1.setText("완도군");
        textView21_1.setText("진도군");
        textView22_1.setText("신안군");
        textView23_1.setText("해외유입");
        ...
        new Thread(){
            ...
            public void run(){
                ...
                try{
                    ...
                    Elements elements = doc.select(".corona_sigun.table_wrap_mobile");


                    for(int i = 0; i<70;i++) {
                        String a = elements.select("tbody > tr > td").get(i).text();

                        if (i == 0) {
                            bundle.putString("목포시총확진자", a);
...
//                        }
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            textView1_3.setText(bundle2.getString("목포시총확진자"));
