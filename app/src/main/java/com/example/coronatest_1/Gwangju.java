        ...
        new Thread(){
            ...
            public void run(){
                ...
                try{
                    ...
                    Elements elements = doc.select(".tb_condition.tb_color3.mt10");


                    textView1_1.setText("동구");
                    textView2_1.setText("서구");
                    textView3_1.setText("남구");
                    textView4_1.setText("북구");
                    textView5_1.setText("광산구");
                    textView6_1.setText("해외유입");
                    textView7_1.setText("타시도");
                    textView8_1.setText("기타");


                    for(int i = 0; i<70;i++) {
                        String a = elements.select("tbody > tr > td").text();
...
//                        }
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            textView1_3.setText(bundle2.getString("동구총확진자"));

            Bundle bundle3 = msg.getData();
            textView2_3.setText(bundle3.getString("서구총확진자"));
//
//            Bundle bundle4 = msg.getData();
//            textView3_3.setText(bundle4.getString("남구총확진자"));
//
//            Bundle bundle5 = msg.getData();
//            textView4_3.setText(bundle5.getString("북구총확진자"));
//
//            Bundle bundle6 = msg.getData();
//            textView5_3.setText(bundle6.getString("광산구총확진자"));
//
//            Bundle bundle7 = msg.getData();
//            textView6_3.setText(bundle7.getString("해외유입총확진자"));
//
//            Bundle bundle8 = msg.getData();
//            textView7_3.setText(bundle8.getString("타시도총확진자"));
//
//            Bundle bundle9 = msg.getData();
//            textView8_3.setText(bundle9.getString("기타총확진자"));
