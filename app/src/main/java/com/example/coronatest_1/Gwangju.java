...
public class Gwangju extends AppCompatActivity {
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            textView6.setText(bundle6.getString("광주총확진자"));

            Bundle bundle7 = msg.getData();
            textView5.setText(bundle7.getString("광주신규확진자"));

            Bundle bundle8 = msg.getData();
            textView7.setText(bundle8.getString("광주완치"));

            Bundle bundle9 = msg.getData();
            textView8.setText(bundle9.getString("광주사망"));
