...
//                try{
//                    doc = Jsoup.connect(url).get();
//                    Elements elements = doc.select(".new_tbl_board.mb20 tr");//테그로 가져오기
//
//
//                    for(int i = 30; i<100;i++) {
//                        String a = elements.select("br").get(i).text();
//
//
//                        if (i == 38) {
//                            bundle.putString("천안당일확진자", a);
//                            Message mmsg = handler.obtainMessage();
//                            mmsg.setData(bundle);
//                            handler.sendMessage(mmsg);
//                            continue;
...
//            textView1_2.setText(bundle18.getString("천안당일확진자"));
//
//            Bundle bundle19 = msg.getData();
//            textView2_2.setText(bundle19.getString("공주당일확진자"));
//
//            Bundle bundle20 = msg.getData();
//            textView3_2.setText(bundle20.getString("보령당일확진자"));
//
//            Bundle bundle21 = msg.getData();
//            textView4_2.setText(bundle21.getString("아산당일확진자"));
//
//            Bundle bundle22 = msg.getData();
//            textView5_2.setText(bundle22.getString("서산당일확진자"));
//
//            Bundle bundle23 = msg.getData();
//            textView6_2.setText(bundle23.getString("논산당일확진자"));
//
//            Bundle bundle24 = msg.getData();
//            textView7_2.setText(bundle24.getString("계룡당일확진자"));
//
//            Bundle bundle25 = msg.getData();
//            textView8_2.setText(bundle25.getString("당진당일확진자"));
//
//            Bundle bundle26 = msg.getData();
//            textView9_2.setText(bundle26.getString("금산당일확진자"));
//
//            Bundle bundle27 = msg.getData();
//            textView10_2.setText(bundle27.getString("부여당일확진자"));
//
//            Bundle bundle28 = msg.getData();
//            textView11_2.setText(bundle28.getString("서천당일확진자"));
//
//            Bundle bundle29 = msg.getData();
//            textView12_2.setText(bundle29.getString("청양당일확진자"));
//
//            Bundle bundle30 = msg.getData();
//            textView13_2.setText(bundle30.getString("홍성당일확진자"));
//
//            Bundle bundle31 = msg.getData();
//            textView14_2.setText(bundle31.getString("예산당일확진자"));
//
//            Bundle bundle32 = msg.getData();
//            textView15_2.setText(bundle32.getString("태안당일확진자"));
//
//            Bundle bundle33 = msg.getData();
//            textView16_2.setText(bundle33.getString("기타당일확진자"));
