...
//                        handler.sendMessage(mmsg2);
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg){
            ...
            textView6.setText(bundles6.getString("서울총확진자"));

            Bundle bundles7 = msg.getData();
            textView5.setText(bundles7.getString("서울신규확진자"));

            Bundle bundles8 = msg.getData();
            textView7.setText(bundles8.getString("서울완치"));

            Bundle bundles9 = msg.getData();
            textView8.setText(bundles9.getString("서울사망"));
